        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-1 lg:space-x-4">
              ...
              >
                <span className="hidden lg:inline">📄 {t.common.statements}</span>
                <span className="lg:hidden">📄</span>
              </Link>
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                    <div className="py-2">
                      {/* Calculators Section */}
                      <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t.navigation.calculators.title}</div>
                      <Link
                      ...
                      <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t.navigation.analytics.title}</div>
                      <Link
              ...
              >
                <span className="hidden lg:inline">🎯 {t.common.scenarios}</span>
                <span className="lg:hidden">🎯</span>
              </Link>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="relative">
                  ...
                  >
                    <span className="hidden lg:inline">👤 {state.profile?.firstName || t.common.account}</span>
                    <span className="lg:hidden">👤</span>
                    <svg className="ml-1 h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                    </svg>
