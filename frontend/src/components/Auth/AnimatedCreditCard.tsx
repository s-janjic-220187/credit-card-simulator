...
const AnimatedCreditCard: React.FC<AnimatedCreditCardProps> = ({
  className = "",
}) => {
  const { t } = useI18n();
        ...
        <div className="card-front">
          ...
          <div className="card-holder">
            <div className="card-holder-label">
              {t.auth.cardDemo.cardHolder}
            </div>
            <div className="card-holder-name">{t.auth.cardDemo.demoUser}</div>
          </div>

          {/* Expiry Date */}
          <div className="card-expiry">
            <div className="expiry-label">{t.auth.cardDemo.expires}</div>
