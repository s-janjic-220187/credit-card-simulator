...
const FinancialHealthCalculator: React.FC = () => {
  ...
  const healthScore = useMemo((): HealthScore & { factors: HealthFactor[] } => {
    ...
    factors.push({
      ...
      maxScore: 10,
      impact: "high",
      explanation: `Your utilization is ${utilization.toFixed(
        1
    ...
    const creditHealth =
      utilizationScore + paymentHistoryScore + creditScorePoints;

    // Debt Management (25 points total)

    // Debt-to-Income Ratio (10 points)
    const debtToIncome =
      (formData.monthlyDebtPayments / formData.monthlyIncome) * 100;
    let dtiScore = 0;
    ...
    factors.push({
      ...
      maxScore: 10,
      impact: "high",
      explanation: `Your debt payments are ${debtToIncome.toFixed(
        1
      )}% of income. Lower ratios indicate better debt management.`,
      recommendations:
        dtiScore < 7
          ? [
    ...
    const paymentStrategyScore =
      paymentStrategyScores[formData.paymentStrategy];
    ...
    factors.push({
      ...
      maxScore: 8,
      impact: "high",
      explanation: `You ${formData.paymentStrategy.replace(
        "_",
        " "
      )} pay your credit cards.`,
      recommendations:
        paymentStrategyScore < 6
          ? [
    ...
    factors.push({
      ...
      maxScore: 8,
      impact: "high",
      explanation: `You have ${marginPercent.toFixed(
        1
      )}% of income available after expenses and debt payments.`,
      recommendations:
        marginScore < 6
          ? [
    ...
    factors.push({
      ...
      maxScore: 5,
      impact: "medium",
      explanation: `Your monthly income of $${formData.monthlyIncome.toLocaleString()} provides ${
        incomeStabilityScore === 5 ? "good" : "adequate"
    ...
    factors.push({
      ...
      maxScore: 10,
      impact: "medium",
      explanation: `You use ${formData.budgetTracking.replace(
        "_",
        " "
      )} budget tracking.`,
      recommendations:
    ...
    if (formData.numCreditCards <= 3 && formData.accountAge >= 2)
      creditManagementScore = 7;
    else if (formData.numCreditCards <= 5 && formData.accountAge >= 1)
      creditManagementScore = 5;
    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Get a comprehensive analysis of your financial health across four key
          areas: credit management, debt control, cash flow, and financial
          habits.
        </p>
      </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder={
                      t.components.financialHealthCalculator.placeholders
                        .balance
                    }
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormData("paymentHistory", e.target.value)
                  }
                  className="w-full border rounded-lg px-3 py-2"
                >
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormData("paymentStrategy", e.target.value)
                  }
                  className="w-full border rounded-lg px-3 py-2"
                >
                  <option value="full">Pay full balance every month</option>
                  <option value="more_than_minimum">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormData("budgetTracking", e.target.value)
                  }
                  className="w-full border rounded-lg px-3 py-2"
                >
                  <option value="detailed">
                    Detailed tracking with apps/spreadsheets
                  </option>
                  <option value="basic">
                    Basic tracking of major categories
                  </option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateFormData("financialGoals", e.target.value)
                  }
                  className="w-full border rounded-lg px-3 py-2"
                >
                  <option value="clear">
                    Clear, specific goals with timelines
                  </option>
                  <option value="general">
                    General goals without specific timelines
                  </option>
                  <option value="vague">
                    Vague ideas about financial future
                  </option>
        ...
        <div className="space-y-6">
            ...
            <div className="text-center mb-6">
              ...
              <div
                className={`text-xl font-semibold px-4 py-2 rounded-full inline-block ${
                  getScoreLevel(healthScore.overall, 100).bgColor
                } ${getScoreLevel(healthScore.overall, 100).color}`}
              >
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {healthScore.creditHealth}/25
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Debt Management</span>
                  <span className="font-medium">
                    {healthScore.debtManagement}/25
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Cash Flow</span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {healthScore.financialHabits}/25
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              {
                name: "Credit Health",
                score: healthScore.creditHealth,
                max: 25,
                icon: "💳",
              },
              {
                name: "Debt Management",
                score: healthScore.debtManagement,
                max: 25,
                icon: "📊",
              },
              {
              ...
              },
              {
                ...
                score: healthScore.financialHabits,
                max: 25,
                icon: "🎯",
              },
            ].map((category) => {
              ...
              return (
                ...
                >
                  <div className="text-center">
                    ...
                    <div
                      className={`text-xs px-2 py-1 rounded-full ${level.bgColor} ${level.color}`}
                    >
                      {level.level}
                    </div>
                  </div>
          ...
          <div className="text-center">
            ...
            >
              {showRecommendations ? "Hide" : "Show"} Detailed Analysis &
              Recommendations
            </button>
          </div>
                        ...
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-sm ${
                              factor.score / factor.maxScore >= 0.8
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul className="text-sm space-y-1">
              <li>
                • <strong>Credit Health:</strong> Utilization, payment history,
                credit score
              </li>
              <li>
                • <strong>Debt Management:</strong> DTI ratio, payment strategy,
                interest rates
              </li>
              <li>
                • <strong>Cash Flow:</strong> Emergency fund, monthly margin,
                income stability
              </li>
              <li>
                • <strong>Financial Habits:</strong> Budgeting, goal setting,
                credit management
              </li>
            </ul>
          </div>
