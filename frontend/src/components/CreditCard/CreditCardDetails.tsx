...
const CreditCardDetails: React.FC<CreditCardDetailsProps> = ({
  ...
  const handleReplacementRequest = async () => {
    ...
    try {
      ...
      await new Promise((resolve) => setTimeout(resolve, 1000));
      alert(
        "Replacement card request submitted. You will receive it in 7-10 business days."
      );
      handleCloseManageModal();
    } catch (error) {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      const fetchTransactions = async () => {
        try {
          const realTransactions = await transactionService.getCardTransactions(
            card.id
          );
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium">
                          {t.components.creditCardDetails.changePIN}
                        </h4>
                        <p className="text-sm text-gray-600">
                          Update your 4-digit PIN for ATM and card transactions
                        </p>
                      </div>
                      <button
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Set daily transaction limits for better control
                        </p>
                      </div>
                      <button
                  ...
                  <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Order a new card (lost, stolen, or damaged)
                        </p>
                      </div>
                      <button
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder={
                          t.components.creditCardDetails.placeholders.pinDefault
                        }
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        {t.components.creditCardDetails.confirmPIN}
                      </label>
                      <input
                        type="password"
                        maxLength={4}
                    ...
                    >
                      {isProcessing
                        ? t.components.creditCardDetails.changingPIN
                        : t.components.creditCardDetails.changePIN}
                    </button>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder={
                          t.components.creditCardDetails.placeholders
                            .spendingLimit
                        }
                      />
                      <p className="text-sm text-gray-500 mt-1">
                        {t.components.creditCardDetails.currentLimitNoLimit}
                      </p>
                    </div>
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-yellow-700 mt-1">
                            ...
                            upon confirmation. The new card will arrive in 7-10
                            business days.
                          </p>
                        </div>
                      </div>
