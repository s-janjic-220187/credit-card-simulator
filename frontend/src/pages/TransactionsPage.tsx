    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">No Credit Cards Found</h2>
          <p className="text-gray-600 mb-6">You need to create a credit card first before managing transactions.</p>
          <button
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your credit card transactions and track spending</p>
        </div>

        {/* Credit Card Selection */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-gray-900">Select Credit Card</h2>
            <button
            ...
            {creditCards.map((card) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-medium text-gray-900">{card.cardholderName}</h3>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className={card.currentBalance > 0 ? 'text-red-600 font-medium' : 'text-green-600'}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${
                        ...
                        (card.currentBalance / card.creditLimit) > 0.6 ? 'bg-yellow-500' : 'bg-green-500'
                      }`}
