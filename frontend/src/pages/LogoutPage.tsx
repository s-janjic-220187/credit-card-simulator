    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-lg text-center max-w-md w-full mx-4">
          ...
          <p className="text-gray-600">{t.logout.loggingOutMessage}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full mx-4">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600">{t.logout.confirmMessage}</p>
          {state.user && (
            <p className="text-sm text-gray-500 mt-2">
              {t.logout.currentlySignedIn}{" "}
              <span className="font-medium">
                {state.profile?.firstName || state.user.email}
              </span>
            </p>
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            {t.logout.actions.confirmLogout}
          </button>
          ...
          >
            {t.logout.actions.switchAccount}
          </button>
